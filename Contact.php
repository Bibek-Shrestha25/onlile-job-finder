<?php
	if(isset($_POST) && !empty($_POST)){
		...
		{
			$sql = "INSERT INTO `tblcontact` (`full_name`, `email`, `message`) VALUES ('{$_POST['fullName']}', '{$_POST['mail']}', '{$_POST['message']}')";
			$mydb->setQuery($sql); 
 	...
 	<div class="container">
 		...
 		<div class="row">
 			<div class="col-md-6">
 				...
 				<!-- Form itself -->
 				<form  id="contactForm" action="?q=Contact" method="post" >
 					<h3>Contact Us</h3>
 					<div class="control-group">
 						<div class="controls">
 							<input type="text" class="form-control" placeholder="Full Name" id="name" name="fullName" required data-validation-required-message="Please enter your name" />
 							<p class="help-block"></p>
 						</div>
 					</div>
 					<div class="control-group">
 						<div class="controls">
 							<input type="email" class="form-control" placeholder="Email" id="email" name="mail" required data-validation-required-message="Please enter your email" />
 						</div>
 					</div>

 					<div class="control-group">
 						<div class="controls">
 							<textarea rows="7" cols="100" class="form-control" placeholder="Message" id="message" name="message" required data-validation-required-message="Please enter your message" minlength="5" data-validation-minlength-message="Min 5 characters" maxlength="999" style="resize:none"></textarea>
 						</div>
 					</div>
 				...
 				<script type="text/javascript">
 					...
 					function init_map() {
 						...
 						infowindow = new google.maps.InfoWindow({
 							content: "<b>ONLINE JOB FINDER</b><br/>44600 Zip code<br/> kathmandu"
 						});
