...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 16, 2023 at 10:28 AM
...
(2023017, 'roshan', 'gurung', 'lama', 'tpj', 'Male', 'Married', '1995-08-17', 'tpj', 27, 'roshan', 'a2104f3edd70c26620a5f25548e35bf5180c4910', 'roosan435@gmail.com', '987978899', 'ptn', 'photos/avatar.jpg', ''),
(2023018, 'bibek', 'shrestha', 'm', 'ktm', 'Male', 'Single', '1997-02-28', 'ktm', 26, 'bibek', '7c4a8d09ca3762af61e59520943dc26494f8941b', '', '9899678978', 'asd', 'photos/avatar.png', '');
...
(2, 'bhatbhateni', 'kathmandu', '023654', '', 'weqwe'),
(3, 'wordlink', 'kathmandu', '035656', '', ''),
(4, 'koshi pvt.ltd', 'biratnagar', '23165', '', ''),
(6, 'civil bank', 'Dharan', '0625656899', '', ''),
(7, 'IT Company', 'Dharan', '04564123', '', '');
...
('00018', 'admin', 'admin', '7c222fb2927d828af22f592134e8932480637c0d', 'Administrator', 'photos/avatar.jpg');
...
--
ALTER TABLE `tblapplicants`
  MODIFY `APPLICANTID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2023019;
...
('root', '[{\"db\":\"erisdb\",\"table\":\"tblcategory\"},{\"db\":\"erisdb\",\"table\":\"tblapplicants\"},{\"db\":\"erisdb\",\"table\":\"tblattachmentfile\"},{\"db\":\"erisdb\",\"table\":\"tblusers\"},{\"db\":\"erisdb\",\"table\":\"tblcompany\"},{\"db\":\"erisdb\",\"table\":\"tblemployees\"},{\"db\":\"erisdb\",\"table\":\"tblfeedback\"},{\"db\":\"erisdb\",\"table\":\"tbljob\"},{\"db\":\"erisdb\",\"table\":\"tbljobregistration\"},{\"db\":\"erisdb\",\"table\":\"tblautonumbers\"}]');
...
('root', '2023-06-16 08:26:25', '{\"Console\\/Mode\":\"collapse\"}');
